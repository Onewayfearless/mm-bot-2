...
// ---- DB ----
const db = new Database("./Eneba MM.sqlite");
...
function helpMainEmbed() {
  return new EmbedBuilder()
    ...
    .setImage("https://media.discordapp.net/attachments/1445083049887928390/1480708558705397820/IMG_1201.png?ex=69b0a8ce&is=69af574e&hm=a95392c63bc35f50f388845380a26822a0a16a4229cb165918dd5d92035c93eb&=&format=webp&quality=lossless&width=1535&height=863")     // BIG banner image
    .setThumbnail("https://media.discordapp.net/attachments/1445083049887928390/1480708557568610424/IMG_1204.gif?ex=69b0a8ce&is=69af574e&hm=9b28320ab588fb4b93ee3c519e5f3d5feca85287a1133f3ad7aa884fd5dcab20&=&width=864&height=864")  // Small logo (top-right)
...
function mmPanelEmbed() {
  return new EmbedBuilder()
    .setColor(0x5b2cff)
    .setTitle("🔒 Eneba — Middleman Service")
    .setDescription(
      "*🧾 Correct Trade Value Required*\n" +
  "*If you're trading and need a Middleman, create a ticket WITH YOUR CORRECT TRADE VALUE.*\n\n" +


  "*💲 Reimbursement Policy*\n" +
  "*If by any chance one of our Middlemen scams you, you will be reimbursed equal value UNLESS the ticket was created in the wrong value category.*\n\n" +


  "*👾 No Hacks / Exploits*\n" +
  "*We DO NOT reimburse hacks or exploits.*\n\n" +


  "*🤝 Join With Trade Items Only*\n" +
  "*Please ensure your trade inventory only contains the specific Pets or Items involved in this deal. Do NOT join with a cluttered inventory to avoid confusion.*\n\n" +


  "*🏷️ No DMs / Tickets Only*\n" +
  "*A Middleman will NEVER trade outside of tickets. They will NEVER DM you.*"
)

    // 🔹 BIG IMAGE (banner)
    .setImage("https://media.discordapp.net/attachments/1445083049887928390/1480708558705397820/IMG_1201.png?ex=69b0a8ce&is=69af574e&hm=a95392c63bc35f50f388845380a26822a0a16a4229cb165918dd5d92035c93eb&=&format=webp&quality=lossless&width=1535&height=863")

    // 🔹 SMALL IMAGE (thumbnail / logo)
    .setThumbnail("https://media.discordapp.net/attachments/1445083049887928390/1480708557568610424/IMG_1204.gif?ex=69b0a8ce&is=69af574e&hm=9b28320ab588fb4b93ee3c519e5f3d5feca85287a1133f3ad7aa884fd5dcab20&=&width=864&height=864")
...
return new EmbedBuilder()
 ...
 .addFields(
  ...
  .setThumbnail("https://media.discordapp.net/attachments/1445083049887928390/1480708557568610424/IMG_1204.gif?ex=69b0a8ce&is=69af574e&hm=9b28320ab588fb4b93ee3c519e5f3d5feca85287a1133f3ad7aa884fd5dcab20&=&width=864&height=864")
  .setImage("https://cdn.discordapp.com/attachments/1480749017708368044/1480837192564605010/IMG_1222.jpeg?ex=69b1209b&is=69afcf1b&hm=a9fd13698bf92778cbff09a4e5e3b3a49bb6c4ca11357dda3bc7f478f7267873&")
